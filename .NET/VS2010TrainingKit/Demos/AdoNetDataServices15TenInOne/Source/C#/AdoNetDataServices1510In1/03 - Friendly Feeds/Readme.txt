By default, when ADO.NET Data Services exposes an instance of an entity type,
...
some oddities when using APP. For instance, 
the APP format requires that every entry include a title and an author.
...
WCF Data Services introduces a feature called “friendly feeds” 
