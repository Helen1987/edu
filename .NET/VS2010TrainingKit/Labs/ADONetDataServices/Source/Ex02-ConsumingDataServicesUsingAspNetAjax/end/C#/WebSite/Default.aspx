...
<body>
    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <p>
                <span>
                    <input type="button" value="New Product" name="btnNew" onclick="showNewProduct();"
                        id="btnNew" /></span> <span>
                            <input type="button" value="Delete Product" name="btnDelete" onclick="deleteProduct();return false;"
                                id="btnDelete" /></span>
            </p>
