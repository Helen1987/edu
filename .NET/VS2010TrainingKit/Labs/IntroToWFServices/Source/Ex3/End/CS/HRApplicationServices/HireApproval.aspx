<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="HireApproval.aspx.cs" Inherits="HRApplicationServices.HireApproval" %>
        ...
        <tr>
            <td class="style3">
                <asp:Button ID="ButtonHire" runat="server" Font-Bold="True" Font-Size="Large" 
                    onclick="ButtonHire_Click" Text="Hire" />
            </td>
            <td>
                <asp:Button ID="ButtonNoHire" runat="server" Font-Bold="True" Font-Size="Large" 
                    onclick="ButtonNoHire_Click" Text="No Hire" />
            </td>
        </tr>
    </table>
</form>
