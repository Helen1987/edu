...
<div id="shopCart">
    ...
    <!------------------------ Collapsed View ------------------------>
    <asp:Panel ID="ShopCartCollapsed" runat="server">
        <p class="summary">
            <span>Items:</span>
    ...
    <!------------------------ Expanded View ------------------------>
    <asp:Panel ID="ShopCartExpanded" runat="server">
        <asp:Panel ID="ShopCartExpandedEmpty" runat="server">
            <p class="empty">
                Your shopping cart is empty.</p>
        </asp:Panel>
        <asp:Panel ID="ShopCartExpandedNonEmpty" runat="server">
            <p class="items">
                    ...
                    <ItemTemplate>
                        <asp:Panel ID="ShoppingCartItem" ClientIDMode="Static" runat="server">
                            <div class="productColumn">
                                <asp:Label ID="Quantity" runat="server"><%#Eval("ProductName")%>&nbsp;(<%#Eval("Quantity")%>)</asp:Label>
                            </div>
                            <div class="priceColumn">
                                <asp:Label ID="TotalPrice" runat="server"><%# string.Format(System.Globalization.CultureInfo.CurrentUICulture, "{0:c}", Eval("TotalPrice"))%></asp:Label>
                            </div>
                        </asp:Panel>
                    </ItemTemplate>
                </asp:ListView>
