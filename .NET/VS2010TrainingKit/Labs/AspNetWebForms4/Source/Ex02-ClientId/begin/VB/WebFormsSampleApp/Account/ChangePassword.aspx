<%@ Page Title="Change Password" Language="vb" MasterPageFile="~/UI.Master" AutoEventWireup="true"
	CodeBehind="ChangePassword.aspx.vb" Inherits="WebFormsSampleApp.Account.ChangePassword" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<asp:ChangePassword ID="ChangeUserPassword" runat="server" CancelDestinationPageUrl="~/" SuccessPageUrl="ChangePasswordSuccess.aspx" RenderOuterTable="false">
		<ChangePasswordTemplate>
			...
			<div class="accountInfo">
				...
				<p>
					<asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" CommandName="Cancel" CssClass="submitButton" 
						Text="Cancel" />
					<asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword" CssClass="submitButton" 
