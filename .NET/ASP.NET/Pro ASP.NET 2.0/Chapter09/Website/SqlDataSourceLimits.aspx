<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SqlDataSourceLimits.aspx.cs" Inherits="SqlDataSourceLimits" %>
...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="sourceEmployees" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:Northwind %>" SelectCommand="SELECT EmployeeID, FirstName, LastName, Title, City FROM Employees WHERE City=@City" OnSelecting="sourceEmployees_Selecting">
            <SelectParameters>
