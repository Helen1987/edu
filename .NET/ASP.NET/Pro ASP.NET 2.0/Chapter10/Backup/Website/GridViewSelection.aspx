<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GridViewSelection.aspx.cs" Inherits="GridViewSelection" %>
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="sourceEmployees"
            Font-Names="Verdana" Font-Size="Small" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="EmployeeID">
