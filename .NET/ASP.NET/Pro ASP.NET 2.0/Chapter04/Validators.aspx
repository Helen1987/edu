    ...
    <table>
				...
				<tr>
					...
					<td>
						...
						<asp:RangeValidator runat="server" ID="ValidateDayOff2" ControlToValidate="DayOff" MinimumValue="08/05/2005"
							MaximumValue="08/20/2005" Type="Date" ErrorMessage="Day Off is not within the valid interval" Display="dynamic" SetFocusOnError="True">*
    			</asp:RangeValidator>
					</td>
				</tr>
				<tr>
